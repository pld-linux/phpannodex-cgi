...
Summary(pl):	Obs³uga mediów Annodex.net jako skrypt obs³uguj±cy CGI
Name:		phpannodex-cgi
Version:	0.4
Release:	1
License:	BSD
...
nastêpuj±ce mo¿liwo¶ci:
 ...
 - obs³ugê czasowych offsetów zapytañ, takich jak
        http://media.example.com/fish.anx?t=npt:01:20.8
   albo
        http://media.example.com/fish.anx?id=Preparation
 - dynamiczne odtwarzanie podsumowañ CMML, je¶li nag³ówek Accept:
